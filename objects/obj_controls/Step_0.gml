/// @description UPDATE
var xx, yy;
	if room == rm_Custom_Controls
	{
		audio_stop_sound(snd_main_menu_theme);
	}
	...
	{
		global.selected_characters = 2
	}
	if keyboard_check(ord("M")) and (global.selected_characters = 1 or global.selected_characters = 2)
	{
		global.selected_characters = 0
	}
