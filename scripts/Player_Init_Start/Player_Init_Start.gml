...
uni_o = shader_get_uniform(shd_player, "outline");
uni_t = shader_get_uniform(shd_player, "texel");
uni_c = shader_get_uniform(shd_player, "current");
uni_uv = shader_get_uniform(shd_player, "UV");
uni_ot = shader_get_uniform(shd_player, "outline_texel");
uni_oc = shader_get_uniform(shd_player, "outline_color");
smp_p = shader_get_sampler_index(shd_player, "palette");